...
namespace Moses
{
	...
	public static class Utils
	{
        ...
        public static DialogResult EmitMessage(MessageTypeOptions TipoMenssagem, string message, string caption)
		{
			switch (TipoMenssagem)
			{
				case MessageTypeOptions.MsgInformacao:
					return MessageBox.Show(message, caption, MessageBoxButtons.OK,MessageBoxIcon.Information);
				case MessageTypeOptions.MsgConfirmacao:
                    return MessageBox.Show(message, caption, MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                case MessageTypeOptions.Error:
        ...
        public static DialogResult EmitMessage(MessageTypeOptions TipoMenssagem)
		{
			switch (TipoMenssagem)
			{
				case MessageTypeOptions.InvalidCnpj:
					return MessageBox.Show("CNPJ Inválido", "Informação", MessageBoxButtons.OK,MessageBoxIcon.Information);
				case MessageTypeOptions.InvalidCpf:
                    return MessageBox.Show("CPF Inválido", "Informação", MessageBoxButtons.OK, MessageBoxIcon.Information);
				case MessageTypeOptions.ConfirmExclusion:
                    return MessageBox.Show("Tem certeza que deseja excluir?", "Confirmação", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
				case MessageTypeOptions.UpdateSuccessfull:
                    return MessageBox.Show("Operação realizada com sucesso", "Informação", MessageBoxButtons.OK, MessageBoxIcon.Information);
				case MessageTypeOptions.UseCurrentRegistryInfo:
                    return MessageBox.Show("Você deseja reaproveitar os dados do registro corrente?", "Confirmação", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
				case MessageTypeOptions.MsgContasReceber:
                    return MessageBox.Show("Gerar contas a receber?", "Confirmação", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
				case MessageTypeOptions.MsgContasPagar:
                    return MessageBox.Show("Gerar contas a pagar?", "Confirmação", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
				case MessageTypeOptions.EnsurePrintQuote:
                    return MessageBox.Show("Imprimir Nota de Pedido?", "Confirmação", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
				default:
                    return DialogResult.None;
			}
		}
